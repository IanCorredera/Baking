...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "recipes.php";
    $whiteListPages[] = "about.php";
    $whiteListPages[] = "BananaBread.php";
    $whiteListPages[] = "BlueberryMuffins.php";
    $whiteListPages[] = "ChocolateChipCookies.php";
    $whiteListPages[] = "Lemon-PoppySeedBread.php";
    $whiteListPages[] = "form.php";
    $whiteListPages[] = "poetsForm.php";
    $whiteListPages[] = "AlmondCloudCookies.php";
    $whiteListPages[] = "ButtermilkGranolaMuffins.php";
    $whiteListPages[] = "ZucchiniLemonMuffins.php";
    $whiteListPages[] = ".php";
    $whiteListPages[] = ".php";
    $whiteListPages[] = ".php";
    ...
    $whiteListFolders[] = "/cs148/Baking";
    
    $whiteListFolders[] = "/education/cs148develop/Baking";
    $whiteListFolders[] = "/develop/cs148develop/Baking";
    
    $whiteListFolders[] = "/cs148develop/Baking";
